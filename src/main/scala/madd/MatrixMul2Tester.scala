...
class MatrixMul2Tester(dut: MatrixMul2) extends PeekPokeTester(dut) {
...
object MatrixMul2Tester extends App {
  chisel3.iotesters.Driver(() => new MatrixMul2(3, 2, 4)) { dut =>
    new MatrixMul2Tester(dut)
  }
}
